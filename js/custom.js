...
$(function(){
	...
	$("#overlayer").delay(10).fadeOut(100);	
...
var portfolioItemClick = function() {
	$('.ajax-load-page').on('click', function(e) {
		...
		TweenMax.to('.loader-portfolio-wrap', 0.25, { top: '-50px', autoAlpha: 1, display: 'block', ease: Power4.easeOut });
	...
	$('body').on('click', '.js-close-portfolio', function() {
		...
		TweenMax.to('.portfolio-single-inner', 0.25, { marginTop: '50px', opacity: 0,  display: 'none', onComplete() {
			TweenMax.to('.portfolio-wrapper', 0.25, { marginTop: '0px', autoAlpha: 1, position: 'relative' });
...
$(document).ajaxStop(function(){
	setTimeout(function(){
		TweenMax.to('.loader-portfolio-wrap', 0.25, { top: '0px', autoAlpha: 0, ease: Power4.easeOut });	
	}, 100);
});
